...
pub struct AgentSettingsContent {
    ...
    /// The model to use for subagents spawned by a main agent.
    ///
    /// Defaults to `default_model` when not specified or when the configured model is unavailable.
    pub subagent_default_model: Option<LanguageModelSelection>,
